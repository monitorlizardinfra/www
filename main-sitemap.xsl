			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Monitor Lizard Infra &#8211; Builder | Architects | Interior Designers Company</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Monitor Lizard Infra &#8211; Builder | Architects | Interior Designers Company</title>
					</xsl:otherwise>
				</xsl:choose>
